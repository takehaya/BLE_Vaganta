...
void setMPU(){
  Wire.begin(26, 25);//Wire.begin(SDA,SCL) ;
#if ARDUINO >= 157
...
void setBeacon() {
    ...
    oBeacon.setMajor(kalAngleX);
    oBeacon.setMinor(kalAngleY);
//  oBeacon.setSignalPower(0xc6);//192
//  oBeacon.setSignalPower(0xba);//192C2
    oBeacon.setSignalPower(0xc2);
...
void loop() {
  ...
  // Create the BLE Server
    ...
    while(true){
      ...
      setBeacon();
//    Serial.println(angle[0], angle[1], angle[2]);
      // Start advertising
      pAdvertising->start();
